            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="kontaktsscoring.id.label" default="Id" /></td>                            
                            <td valign="top" class="value">${fieldValue(bean: kontaktsscoringInstance, field: "id")}</td>                            
                        </tr>
                    
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="kontaktsscoring.bezeichnung.label" default="Bezeichnung" /></td>                            
                            <td valign="top" class="value">${fieldValue(bean: kontaktsscoringInstance, field: "bezeichnung")}</td>                            
                        </tr>
