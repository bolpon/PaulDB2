        ...
        <div class="body">
            ...
            <div class="buttons">
                <g:form>
                    ...
                    <sec:ifAllGranted roles="ROLE_ADMIN"><span class="button"><g:actionSubmit class="delete" onclick="return confirm('Are you sure?');" value="Delete" /></span></sec:ifAllGranted>
                </g:form>
            </div>
        </div>
    </body>
